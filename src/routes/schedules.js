...
function parseCandidateNames(candidateStr) {
  return candidateStr
    .split('\n')
    .map((s) => s.trim())
    .filter((s) => s !== '');
        ...
        `;
          ...
          <tr>
            ...
            return html`
                <td>
                  <p>
                  <small id="${user.isSelf ? "self-comment" : ""}">${comment}
                  </small>
                  </p>
                  ${user.isSelf
                ? html`
        ...
        <form class="my-3" method="post" action="/schedules/${schedule.scheduleId}/update">
          ...
          <div class="mb-3">
            ...
            <ul class="list-group mb-2">
              ${candidates.map(
        (candidate) => html`<li <li class="list-group-item">${candidate.candidateName}</li>`,
      )}
            </ul>
